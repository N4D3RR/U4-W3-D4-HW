...
import naderdeghaili.dao.AttendancesDAO;
import naderdeghaili.dao.EventsDAO;
import naderdeghaili.dao.LocationsDAO;
import naderdeghaili.dao.PeopleDAO;
...
public class Application {
    private static final EntityManagerFactory emf = Persistence.createEntityManagerFactory("U4-W3-D4-HW");
    ...
    public static void main(String[] args) {
        ...
        Event event = eventsDAO.findById(1);
